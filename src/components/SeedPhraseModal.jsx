...
const SeedPhraseModal = ({ seed, onClose }) => {
      ...
      <div className="relative w-full max-w-md bg-[#0d1117] border border-[#1e2a35] rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="bg-[#0a1520] px-6 pt-6 pb-4 border-b border-[#1e2a35]">
          <div className="flex items-center gap-3 mb-1">
            ...
            <div>
              <h2 className="text-white font-semibold text-base">Your Seed Phrase</h2>
              <p className="text-[#687e8e] text-xs">Wallet created on Base Sepolia</p>
            </div>
          </div>
        </div>
        ...
        <div className="px-6 py-5 space-y-4">
          ...
          <div className="flex items-start gap-2.5 bg-yellow-500/10 border border-yellow-500/20 rounded-xl px-4 py-3">
            ...
            <p className="text-yellow-300 text-xs leading-relaxed">
              Write this down and store it safely. Anyone with this phrase can access your wallet. We cannot recover it for you.
            </p>
          </div>
          ...
          <label className="flex items-start gap-2.5 cursor-pointer group">
            <div className="relative mt-0.5 shrink-0">
              ...
              />
              <div className={`h-4 w-4 rounded border transition-all ${confirmed ? "bg-[#1ee3bf] border-[#1ee3bf]" : "border-[#3a4a5a] bg-transparent"} flex items-center justify-center`}>
                {confirmed && <MdCheckCircle className="h-3.5 w-3.5 text-black" />}
              </div>
            </div>
            <span className="text-[#687e8e] text-xs leading-relaxed group-hover:text-white transition-colors">
              I have saved my seed phrase in a safe place and understand I cannot recover it if lost.
            </span>
          </label>
